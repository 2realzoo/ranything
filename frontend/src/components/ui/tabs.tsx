...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'inline-flex items-center justify-start rounded-md bg-background border border-border p-1 gap-1',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      'data-[state=active]:bg-surface data-[state=active]:text-accent data-[state=active]:border data-[state=active]:border-accent/30 data-[state=active]:shadow-sm',
